...
\begin{center}
  ...
  \catcode`_=12
  \small
  \captionof{table}{Math functions} \label{line:methods_maths}
\begin{tabular}{ll}
\toprule
...
\subsection{\tkzFct{tkz}{solve(...)}} % (fold)
...
% subsection function_solve (end)


\subsection{Function \tkzFct{math}{solve\_linear\_system(M, N)}} % (fold)
...
% subsection solve_linear_system (end)
