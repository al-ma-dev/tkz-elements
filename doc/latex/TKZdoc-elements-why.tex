...
\end{mybox}
 ...
 \tkzHand $\sqrt{65^2+72^2} \approx \pmpn{\pgfmathresult} $ .
...
gives: \tkzHand $\sqrt{65^2+72^2} = \pmpn{\luaveclen{65}{72}} $ {\color{red}!!}
...
\texttt{Note: } This code has been replaced by a more elegant version.
...
\texttt{Note: } The following code replaces the previous version with a more elegant and object-oriented approach.
