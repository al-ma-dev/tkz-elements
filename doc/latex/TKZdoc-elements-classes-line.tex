...
\subsection{Creating a Line} % (fold)
...
% subsection creating_a_line (end)
...
\subsubsection{Note on line object attributes} % (fold)
\label{ssub:note_on_attributs_line}
...
% subsubsection note_on_attributs_line (end)
...
\begin{center}
  ...
  \catcode`_=12
  \small
  \captionof{table}{Methods of the class line.(part 1)}\label{line:methods}
  \begin{tabular}{ll}
  \toprule
...
\end{center}
\end{tkzexample}
% subsubsection method_line_new_pt_pt(end)

% subsection methods_from_class_line(end)

\subsection{The result is a number} % (fold)
\label{sub:the_result_is_a_number}
...
% subsubsection method_line_distance(end)
% subsection the_result_is_a_number (end)
...
\subsubsection{Method \tkzMeth{line}{get()}} % (fold)
...
\end{tkzexample}
s
% subsubsection method_line_get (end)
...
\subsubsection{Method \tkzMeth{line}{midpoint()}} % (fold)
...
% subsubsection method_line_midpoint (end)

\subsubsection{Method \tkzMeth{line}{harmonic\_int(pt)}} % (fold)
...
% subsubsection method_line_harmonic_int (end)

\subsubsection{Method \tkzMeth{line}{harmonic\_ext(pt)}} % (fold)
...
% subsubsection method_imeth_line_harmonic__ext_pt (end)

\subsubsection{Method \tkzMeth{line}{harmonic\_both(k)}} % (fold)
...
% subsubsection harmonic_both (end)

\subsubsection{Methode \tkzMeth{line}{gold\_ratio}} % (fold)
...
% subsubsection methode_imeth_line_gold__ratio (end)
...
% subsubsection method_line_colinear__at(end)
...
% subsubsection method_line_orthogonal__at(end)


\subsubsection{Method \tkzMeth{line}{random()}} % (fold)
\label{ssub:method_line_random}
The method returns a point belonging to the segment.

% subsubsection method_line_random (end)
...
\subsubsection{Comparison between \texttt{colinear\_at} and \texttt{ll\_from} methods} % (fold)
...
% subsubsection comparison_between_texttt_colinear__at_and_texttt_ll__from_methods (end)
...
% subsubsection new_line_from_a_defined_line(end)
\subsubsection{Comparison between \texttt{orthogonal\_at} and \texttt{ortho\_from}} % (fold)
...
\egroup
\end{center}
% subsubsection comparison_between_texttt_orthogonal__at_and_texttt_ortho__from (end)
...
% subsubsection method_line_mediator(end)

\subsubsection{Method \tkzMeth{line}{swap\_line}} % (fold)
...
% subsubsection method_line_swap__line (end)
...
\subsubsection{Method \tkzMeth{line}{equilateral(<'swap'>)}} % (fold)
...
% subsubsection method_line_equilateral(end)

\subsubsection{Method \tkzMeth{line}{isosceles(d, <'swap'>)}} % (fold)
...
% subsubsection method_line_isosceles(end)
\subsubsection{Method \tkzMeth{line}{school(<'swap'>)}} % (fold)
\label{ssub:method_imeth_line_school_swap}

% subsubsection method_imeth_line_school_swap (end)
...
% subsubsection method_imeth_line_school (end)

\subsubsection{Method \tkzMeth{line}{half(<'swap'>)}} % (fold)
...
% subsubsection method_imeth_line_half_swap (end)

\subsubsection{Method \tkzMeth{line}{two\_angles(an, an)}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{s\_s(d, d)}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{sa\_(d, an, <'swap'>)}} % (fold)
...
% subsubsection _line_sas_d_an (end)

\subsubsection{Method \tkzMeth{line}{\_as(d, an,<'swap'>)}} % (fold)
...
% subsubsection _line__as_d_an_swap (end)

\subsubsection{Method \tkzMeth{line}{s\_a(d, an, <'swap'>)}} % (fold)
...
% subsubsection _line_ssa_d_an_swap (end)

\subsubsection{Method \tkzMeth{line}{a\_s(d,an,<'swap'>)}} % (fold)
\label{ssub:_line_a__s_d_an_swap}

% subsubsection _line_a__s_d_an_swap (end)

\subsubsection{Summary of triangle construction methods from a line} % (fold)
...
% subsubsection synthesis_of_triangle_constructions (end)

% subsection the_result_is_a_triangle (end)

\subsection{The result is a sacred triangle} % (fold)
...
\subsubsection{Method \tkzMeth{line}{gold()}} % (fold)
...
% subsubsection method_line_gold (end)

\subsubsection{Method \tkzMeth{line}{golden()}} % (fold)
...
% subsubsection method_line_golden (end)

\subsubsection{Method \tkzMeth{line}{golden\_gnomon()}} % (fold)
...
% subsubsection method_line_golden__gnomon (end)
\subsubsection{Method \tkzMeth{line}{pythagoras()}} % (fold)
...
% subsubsection _line_egyptian (end)

% subsection the_result_is_a_sacred_triangle (end)

\subsection{The result is a circle} % (fold)


\subsubsection{Method \tkzMeth{line}{apollonius(d)}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{c\_l\_pp}} % (fold)
\label{ssub:c_l_pp}
...
\subsubsection{Method \tkzMeth{line}{c\_ll\_p}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{square(<'swap'>)}} % (fold)
...
% subsubsection method_line_square (end)
% subsection the_result_is_a_square (end)

\subsection{Transformations: the result is an object} % (fold)
...
\subsubsection{Method \tkzMeth{line}{projection(obj)}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{projection\_ll(L, obj)}} % (fold)
...
\end{tkzexample}
% subsubsection method_line_projection__ll(end)

\subsubsection{Method \tkzMeth{line}{affinity(L, k, obj)}} % (fold)
...
% subsubsection method_line_affinity(end)

\subsubsection{Method \tkzMeth{line}{translation(obj)}} % (fold)
...
\subsubsection{Method \tkzMeth{line}{reflection(obj)}} % (fold)
...
% subsection the_result_is_an_object (end)
\subsubsection{Method \tkzMeth{line}{path}: Creating a path} % (fold)
...
% paragraph examples (end)
% subsubsection line_path (end)
