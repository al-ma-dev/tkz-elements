\newpage\section{Class  \tkzClass{matrix}} % (fold)
\label{sec:matrices}
...
\subsubsection{Attribute \tkzAttr{matrix}{type}} % (fold)
...
% subsubsection attribute_iattr_matrix_type (end)

\subsubsection{Attribute \tkzAttr{matrix}{set}} % (fold)
...
\subsubsection{Attributes \tkzAttr{matrix}{rows} and \tkzAttr{matrix}{cols}} % (fold)
...
\directlua{
 ...
 tex.print("Cols:  "..M.n.cols)}
\end{minipage}
% subsubsection attributes_matrix_rows_and_col (end)

\subsubsection{Attributes \tkzAttr{matrix}{det} } % (fold)
...
% subsubsection attributes_iattr_matrix_det (end)
...
\subsubsection{Method  \tkzMeth{matrix}{print}} % (fold)
...
\subsubsection{Function \tkzFct{matrix}{new}} % (fold)
...
\subsubsection{Function \tkzFct{matrix}{vector}} % (fold)
...
\subsubsection{Function \tkzFct{matrix}{row\_vector}} % (fold)
...
% subsubsection function_row_vector (end)

\subsubsection{Method \tkzMeth{matrix}{create(n,m)}} % (fold)
...
% subsubsection function_matrix_create_n_m (end)

\subsubsection{Method \tkzMeth{matrix}{square}(liste)} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{identity}}% (fold)
...
\directlua{
  ...
  M.Id_3:print()}
\end{minipage}
% subsubsection method_identity (end)

\subsubsection{Method  \tkzMeth{matrix}{is\_orthogonal}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{is\_diagonal}} % (fold)
...
\subsubsection{Function \tkzFct{matrix}{print\_array}} % (fold)
...
\subsubsection{Method  \tkzMeth{matrix}{get}} % (fold)
...
\subsubsection{Method  \tkzMeth{matrix}{inverse}} % (fold)
...
\subsubsection{Method  \tkzMeth{matrix}{transpose}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{adjugate}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{diagonalize}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{homogenization}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{htm}} % (fold)
...
\subsubsection{Method \tkzMeth{matrix}{get\_htm\_point}} % (fold)
...
\directlua{
  ...
  tex.print(tkz.display(z.P))}
\end{minipage}
% subsubsection method_get_htm_point (end)


\subsubsection{Method \tkzMeth{matrix}{htm\_apply}} % (fold)
