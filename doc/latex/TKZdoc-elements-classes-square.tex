\newpage
\section{Class \tkzClass{square}} % (fold)
...
\subsection{Creating a square} % (fold)
...
\end{verbatim}
\end{mybox}
% subsection creating_a_square (end)
...
\subsubsection{Method \tkzFct{square}{rotation(pt,pt)}} % (fold)
...
% subsubsection method_square_rotation(end)

\subsubsection{Method \tkzFct{square}{side (za,zb)}} % (fold)
