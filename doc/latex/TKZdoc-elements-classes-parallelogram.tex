\newpage
\section{Class \tkzClass{parallelogram}} % (fold)
...
\subsection{Creating a parallelogram} % (fold)
...
\end{verbatim}
\end{mybox}
% subsection creating_a_parallelogram (end)
...
\subsection{Parallelogram functions} % (fold)
...
\subsubsection{Method \tkzMeth{parallelogram}{new(pt,pt,pt,pt)}} % (fold)
...
% subsubsection function_parallelogram_new (end)

\subsubsection{Method \tkzMeth{parallelogram}{fourth(pt,pt,pt)}} % (fold)
