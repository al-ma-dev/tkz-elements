...
\texttt{The last case: the lines are parallel}
...
\begin{tikzpicture}[scale=.5]
 ...
 \tkzClip
 \tkzDrawLines[thick,blue,add =.5 and .5](A,B C,D)
 \tkzDrawPoints[blue,size=3](O)
 \tkzDrawCircles[thick,red](w1,t1 w2,t2)
 \tkzDrawCircles[thick,blue](O,X)
 \tkzLabelPoints[red](O, w1, w2)
\end{tikzpicture}
\end{center}
\end{tkzexample}
...
\texttt{Purpose: } Circles tangent to three given circles \(C_1=\) \verb|self|, \(C_2\), \(C_3\) (up to 8 solutions).
...
\vspace{1em}
\texttt{Example with CLP and CCL}

Related circles from Leon Bankoff. The shaded circles are equal and the unshaded circles are equal.
...
\directlua{
  ...
  push(z.m1, z.th1)
  push(z.m2, z.th2)
  local pw, pt = C.AO:CLP(L.OB,z.M)
  z.w1 = pw:get(1)
  z.t1 = pt:get(1)
  push(z.w1, z.t1 )
  C.w1 = circle(z.w1, z.t1)
  local pw, pt = C.AO:CCL(C.w1, L.OB)
  z.c1 = pw:get(1)
  z.h1 = pt:get(1)
  z.c2 = pw:get(2)
  z.h2 = pt:get(2)
...
\begin{tikzpicture}
  \tkzGetNodes
  \tkzDrawSector(A,B)(O)
  \tkzDrawLine[add=0 and 0](O,B)
  \tkzDrawPolygon(A2,A,B2, M)
  \tkzDrawPoints(A,O,B,M)
  \tkzDrawCirclesFromPaths[draw,red](PA.c, PA.t)
  \tkzFillCircles[pattern={north east lines}](w1,t1 m1,th1 m2,th2)
\end{tikzpicture}
\end{center}
\end{tkzexample}
