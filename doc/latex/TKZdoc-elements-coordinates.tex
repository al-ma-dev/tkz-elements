\newpage\section{Coordinates} % (fold)
...
\subsection{Common Use of Coordinates} % (fold)
...
Coordinates of $M$ 
   ...
   \end{scope}
   \end{tikzpicture}
% subsection common_use_of_coordinates (end)

\subsection{Use of barycentric coordinates.} % (fold)
...
% subsection use_of_barycentric_coordinates (end)

\subsection{Use of Trilinear Coordinates} % (fold)
...
% subsection use_of_trilinear_coordinates (end)

\subsection{OCCS} % (fold)
\label{sub:occs}
