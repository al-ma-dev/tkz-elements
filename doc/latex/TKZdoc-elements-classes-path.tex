...
\subsubsection{Method \tkzMeth{path}{add\_pair\_to\_path(p, p, n)}}
...
\subsubsection{Method \tkzMeth{path}{path\_from\_pairs(p, p, n)}}
...
\subsubsection{Method \tkzMeth{path}{stock\_paths(...)}}
