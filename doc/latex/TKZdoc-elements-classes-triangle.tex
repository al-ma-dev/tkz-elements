...
\subsection{Creating a triangle} % (fold)
...
\end{verbatim}
\end{mybox}
% subsection creating_a_triangle (end)
...
\subsubsection{Triangle attributes: definition points} % (fold)
...
\end{tkzexample}
\end{minipage}
% subsubsection triangle_attributes_points (end)

\subsubsection{Triangle attributes: characteristic points} % (fold)
...
\end{tkzexample}
\end{minipage}
% subsubsection triangle_attributes_characteristic_points (end)
...
\end{tkzexample}
% subsubsection triangle_attributes_angles(end)

\subsubsection{Triangle attributes: lengths} % (fold)
...
\end{tkzexample}
\end{mybox}
% subsection triangle_attributes_lengths (end)

\subsubsection{Triangle attributes: straight lines} % (fold)
...
\begin{tikzpicture}
  ...
  \end{tikzpicture}
\end{tkzexample}
% subsubsection triangle_attributes_straight_lines (end)
% subsubsection attributes_of_a_triangle(end)
...
\subsubsection{Method \tkzMeth{triangle}{new(pt, pt, pt)}} % (fold)
...
\begin{mybox}
  ...
  \end{tkzexample}
\end{mybox}
% subsubsection method_triangle_new_pt_pt_pt (end)

\subsubsection{Method \tkzMeth{triangle}{get(<i>)}} % (fold)
...
% subsubsection method_triangle_get (end)
%%%%%%%%%%%%%%% boolean %%%%%%%%%%%%
\subsection{The result is a boolean} % (fold)


\subsubsection{Method \tkzMeth{triangle}{in\_out(pt)}} % (fold)
...
% subsubsection _triangle_in__out_pt (end)

\subsubsection{Method \tkzMeth{triangle}{check\_equilateral()}} % (fold)
...
% subsubsection _triangle_check__equilateral (end)

\subsubsection{Method \tkzMeth{triangle}{check\_acutangle()}} % (fold)
...
\end{verbatim}
\end{mybox}
% subsubsection _triangle_check__acutangle (end)
% subsection the_result_is_a_boolean (end)
...
\subsection{The result is a real} % (fold)

\subsubsection{Method \tkzMeth{triangle}{area()}} % (fold)
\label{ssub:method_triangle_area}

This method returns the area of the triangle. However, it is preferable to access the area using the precomputed \code{area} attribute rather than calling the method.

\medskip
\noindent
\textbf{Recommended usage:}
\begin{mybox}
\code{T.ABC.area} \quad instead of \quad \code{T.ABC:area()}
\end{mybox}
...
% subsubsection method_triangle_area (end)

\subsubsection{Method \tkzMeth{triangle}{barycentric\_coordinates(pt)}} % (fold)
...
% subsubsection _triangle_barycentric__coordinates_pt (end)

\subsubsection{Method \tkzMeth{triangle}{trilinear\_coordinates(pt)}} % (fold)
...
% subsubsection triangle_trilinear_coordinates_pt (end)

\subsubsection{Method \tkzMeth{triangle}{get\_angle(n)}} % (fold)
...
% subsubsection method_triangle_get_angle (end)
% subsection the_result_is_a_real (end)
...
\subsection{The result is a point} % (fold)

\subsubsection{Method \tkzMeth{triangle}{point(r)}} % (fold)
...
% subsubsection method_triangle_point_r (end)

\subsubsection{Method \tkzMeth{triangle}{random(<'inside'>)}} % (fold)
...
% subsubsection method_triangle_random_inside (end)

\subsubsection{Method \tkzMeth{triangle}{barycentric(ka, kb, kc)}} % (fold)
...
% subsubsection _triangle_barycentric_ka_kb_kc (end)

\subsubsection{Method \tkzMeth{triangle}{trilinear(x, y, z)}} % (fold)
...
% subsubsection method_triangle_trilinear_x_y_z (end)
...
% subsubsection method_triangle_base(end)


\subsubsection{Method \tkzMeth{triangle}{kimberling(n)}} % (fold)
...
\end{center}
\end{tkzexample}
% subsubsection method_triangle_kimberling_n (end)
...
% subsubsection method_triangle_isogonal(end)

\subsubsection{Method \tkzMeth{triangle}{bevan\_point()}} % (fold)
...
% subsubsection method_imeth_triangle_bevan_point (end)
\subsubsection{Method \tkzMeth{triangle}{excenter}(pt)} % (fold)
...
% subsubsection method_triangle_excenter_pt (end)

\subsubsection{Method \tkzMeth{triangle}{projection}(pt)} % (fold)
...
% subsubsection method_triangle_projection_pt (end)

\subsubsection{Method \tkzMeth{triangle}{parallelogram()}} % (fold)
...
% subsubsection method_triangle_parallelogram (end)
...
% subsubsection method_triangle_mittenpunkt(end)
...
% subsubsection method_triangle_nagel__point(end)
...
%subsubsection method_point_feuerbach(end)

\subsubsection{Method \tkzMeth{triangle}{symmedian\_point()}} % (fold)
...
% subsubsection method_triangle_lemoine_point (end)

\subsubsection{Method \tkzMeth{triangle}{spieker\_center}} % (fold)
...
% subsubsection method_triangle_spieker_center (end)
...
% subsubsection method_triangle_euler__points(end)
...
% subsubsection method_triangle_nine__points(end)

\subsubsection{Method \tkzMeth{triangle}{soddy\_center}} % (fold)
...
% subsubsection method_triangle_soddy_center (end)

\subsubsection{Method \tkzMeth{triangle}{conway\_points()}} % (fold)
...
% subsubsection method_triangle_conway_points (end)

\subsubsection{Method \tkzMeth{triangle}{first\_fermat\_point()}} % (fold)
...
% subsubsection method_triangle_first_fermat_point (end)

\subsubsection{Method \tkzMeth{triangle}{second\_fermat\_point()}} % (fold)
\label{ssub:method_triangle_second__fermat__point}
See  [\ref{ssub:method_triangle_fermat__axis}]
]
% subsubsection method_triangle_second__fermat__point (end)

\subsubsection{Method \tkzMeth{triangle}{kenmotu\_point()}} % (fold)
...
% subsubsection _triangle_kenmotu__point (end)

\subsubsection{Method \tkzMeth{triangle}{adams\_points()}} % (fold)
...
% subsubsection method_triangle_adams_points (end)

\subsubsection{Method \tkzMeth{triangle}{macbeath\_point}} % (fold)
...
\end{tikzpicture}
\end{tkzexample}
% subsubsection method_triangle_macbeath_point (end)

\subsubsection{Method \tkzMeth{triangle}{poncelet\_point}(p)} % (fold)
...
% subsubsection method_tkzmeth_triangle_poncelet__point_p (end)

\subsubsection{Method \tkzMeth{triangle}{orthopole}} % (fold)
...
\end{center}
\end{tkzexample}
% subsubsection method_tkzmeth_triangle_orthopole (end)

% subsection the_result_is_a_point (end)
...
\subsection{The result is a line} % (fold)

\subsubsection{Method \tkzMeth{triangle}{symmedian\_line(n)}} % (fold)
...
% subsubsection method_imeth_triangle_symmedian__line (end)
...
% subsubsection method_triangle_altitude(end)
...
% subsubsection method_triangle_bisector(end)

\subsubsection{Method \tkzMeth{triangle}{bisector\_ext(arg)}} % (fold)
...
% subsubsection method_triangle_bisector_ext (end)


\subsubsection{Method \tkzMeth{triangle}{mediator(...)}} % (fold)
...
% subsubsection triangle_mediator (end)



\subsubsection{Method \tkzMeth{triangle}{antiparallel(arg)}} % (fold)
\label{antiparallel}
...
% subsubsection antiparallel (end)

\subsubsection{Method  \tkzMeth{triangle}{orthic\_axis()} and \tkzMeth{triangle}{orthic\_axis\_points()}} % (fold)
...
% subsubsection method_triangle_orthic_axis_points (end)
...
\end{center}
\end{tkzexample}
% subsubsection method_triangle_steiner__line(end)
...
% subsubsection method_triangle_lemoine__line(end)
...
% subsubsection method_triangle_fermat__axis(end)
...
\vspace{1em}
% subsubsection method_triangle_brocard__axis(end)
...
\end{center}
\end{tkzexample}
% subsubsection method_triangle_simson__line(end)

% subsection the_result_is_a_line (end)
...
\subsection{The result is a circle} % (fold)
...
\end{center}
\end{tkzexample}
% subsubsection method_triangle_euler_circle(end)
...
\end{center}
\end{tkzexample}
% subsubsection method_triangle_circum_circle(end)
...
\end{verbatim}
\end{minipage}
% subsubsection method_triangle_in_circle(end)
...
\begin{center}
  ...
  \tkzMarkRightAngles[fill=gray!20,
       opacity=.4](A,Zk,K A,Yk,K K,Xk,B)
  \end{tikzpicture}
\end{center}
...
% subsubsection method_triangle_ex__circle(end)
...
% subsubsection method_triangle_spieker__circle(end)

\subsubsection{Method \tkzMeth{triangle}{cevian\_circle}(pt)} % (fold)
...
% subsubsection _triangle_cevian__circle_pt (end)


\subsubsection{Method \tkzMeth{triangle}{symmedial\_circle()}} % (fold)
...
% subsubsection method_triangle_symmedial (end)
% subsubsection method_triangle_symmedial (end)
...
\end{tikzpicture}
\end{tkzexample}
% subsubsection methode_triangle_conway(end)
...
% subsubsection method_triangle_pedal(end)



\subsubsection{Method \tkzMeth{triangle}{first\_lemoine\_circle()}} % (fold)
...
% subsubsection method_triangle_first_lemoine_circle (end)


\subsubsection{Method \tkzMeth{triangle}{second\_lemoine\_circle()}} % (fold)
\label{ssub:method_triangle_second_lemoine_circle}
...
% subsubsection method_triangle_second_lemoine_circle (end)
...
% subsubsection methods_triangle_bevan_circle (end)
...
% subsubsection method_triangle_taylor__circle(end)


\subsubsection{Method \tkzMeth{triangle}{adams\_circle()}} % (fold)
...
% subsubsection method_triangle_adams_circle (end)

% lamoen_points()
\subsubsection{Method \tkzMeth{triangle}{lamoen\_points}} % (fold)
...
% subsubsection method_triangle_lamoen_points (end)


\subsubsection{Method \tkzMeth{triangle}{soddy\_circle()}} % (fold)
...
% subsubsection method_triangle_soddy_circle (end)

\subsubsection{Method \tkzMeth{triangle}{yiu\_circles()}} % (fold)
...
% subsubsection method_yiu_circles (end)


\subsubsection{Method \tkzMeth{triangle}{kenmotu\_circle()}} % (fold)
...
% subsubsection kenmotu_circle (end)


\subsubsection{Method \tkzMeth{triangle}{c\_ll\_p}} % (fold)
...
% subsubsection method_triangle_c_ll_p (end)

\subsubsection{Method \tkzMeth{triangle}{thebault} or \tkzMeth{triangle}{c\_c} } % (fold)
...
\directlua{
 ...
 z.wa, z.Ea = T.ABC:thebault(z.A, C.main):get()
 L.med = T.ABC:mediator(z.B)
 z.Ob = L.med:point(1)
 C.main = circle(z.Ob, z.C)
 z.wb, z.Eb = T.ABC:thebault(z.B, C.main):get()
 L.med = T.ABC:mediator(z.C)
 z.Oc = L.med:point(1)
 C.main = circle(z.Oc, z.A)
 z.wc, z.Ec = T.ABC:thebault(z.C, C.main):get()
 }
...
\begin{tikzpicture}[scale = .75]
  ...
  \tkzDrawCircles(Oa,C wa,Ea Ob,C wb,Eb Oc,A wc,Ec)
...
% subsubsection method_tkzmeth_triangle_c__c (end)

\subsubsection{Method \tkzMeth{triangle}{mixtilinear\_incircle(arg)}}
\label{ssub:method_triangle_mixti}

A circle that in internally tangent to two sides of a triangle and to the circumcircle is called a mixtilinear incircle. There are three mixtilinear incircles, one corresponding to each angle of the triangle. [\href{https://mathworld.wolfram.com/MixtilinearIncircles.html}{MathWorld — van Lamoen, Floor. "Mixtilinear Incircles.}]
...
% subsubsection method_triangle_mixti (end)
...
z.C = point:new (1, 4)
T.ABC = triangle:new(z.A, z.B, z.C)
C.A, C.B, C.C = T.ABC:three_tangent_circles()
z.ta = C.A.through
z.tb = C.B.through
z.tc = C.C.through
...
% ubsubsection method_triangle_three_tgt_c (end)

$  $

% subsection the_result_is_a_circle (end)
...
\subsection{The result is a triangle} % (fold)
...
% subsubsection method_triangle_medial(end)

\subsubsection{Method \tkzMeth{triangle}{orthic()}} % (fold)
...
% subsubsection method_triangle_orthic (end)

\subsubsection{Method \tkzMeth{triangle}{incentral()}} % (fold)
...
\subsubsection{Method \tkzMeth{triangle}{excentral()}} % (fold)
...
% subsubsection method_triangle_excentral (end)


\subsubsection{Method \tkzMeth{triangle}{intouch()}} % (fold)
...
% subsubsection method_triangle_intouch (end)

\subsubsection{Method \tkzMeth{triangle}{extouch()}} % (fold)
...
% subsubsection method_triangle_extouch (end)

\subsubsection{Method \tkzMeth{triangle}{feuerbach()}} % (fold)
...
% subsubsection method_triangle_feurbach (end)
\subsubsection{Method \tkzMeth{triangle}{cevian()}} % (fold)
...
% subsubsection method_triangle_cevian (end)
...
\subsubsection{Method \tkzMeth{triangle}{euler()}} % (fold)
...
% subsubsection method_triangle_euler (end)

\subsubsection{Method \tkzMeth{triangle}{yiu()}} % (fold)
...
% subsubsection method_triangle_yiu (end)

\subsubsection{Method \tkzMeth{triangle}{reflection()}} % (fold)
...
\end{tikzpicture}
\end{tkzexample}
% subsubsection method_triangle_reflection (end)

\subsubsection{Method \tkzMeth{triangle}{circumcevian(pt)}} % (fold)
...
% subsubsection method_triangle_circumcevian (end)
...
% subsubsection method_triangle_tangential(end)
...
\subsubsection{Method \tkzMeth{triangle}{lemoine()}} % (fold)
...
% subsubsection method_triangle_lemoine (end)

\subsubsection{Method \tkzMeth{triangle}{macbeath()}} % (fold)
...
% subsubsection method_triangle_macbeath (end)


% subsubsection method_triangle_anti(end)
% subsection the_result_is_a_triangle (end)
...
%%%%%%%%%%%%%%%%%%%%
\subsection{The result is a conic} % (fold)
...
\subsubsection{Method \tkzMeth{triangle}{kiepert\_parabola}} % (fold)
...
% subsubsection method_triangle_kiepert_parabola (end)

\subsubsection{Method \tkzMeth{triangle}{kiepert\_hyperbola()}} % (fold)
...
% subsubsection method_triangle_kiepert__hyperbola (end)
...
\subsubsection{Method \tkzMeth{triangle}{lemoine\_inellipse}} % (fold)
...
% subsubsection method_triangle_lemoine_inellipse (end)

\subsubsection{Method \tkzMeth{triangle}{brocard\_inellipse}} % (fold)
...
% subsubsection method_triangle_brocard__inellipse (end)


\subsubsection{Method \tkzMeth{triangle}{macbeath\_inellipse}} % (fold)
...
% subsubsection method_triangle_macbeath__inellipse (end)

\subsubsection{Method \tkzMeth{triangle}{mandart\_inellipse}} % (fold)
...
% subsubsection method_triangle_mandart__inellipse (end)

\subsubsection{Method \tkzMeth{triangle}{orthic\_inellipse}} % (fold)
...
% subsubsection method_triangle_orthic__inellipse (end)

% subsection the_result_is_a_conic (end)
%%%%%%%%%%%%%%%%%%%

%%% Misc.

%%%%%%%%%%%%%%%%%%%%
\subsection{The result is a square} % (fold)


\subsubsection{Method \tkzMeth{triangle}{square\_inscribed(n)}} % (fold)
...
% subsubsection method_triangle_square__inscribed (end)
% subsection the_result_is_a_square (end)

\subsubsection{Method \tkzMeth{triangle}{path()}} % (fold)
\label{ssub:method_tkzmeth_triangle_path}

This method builds a \tkzClass{path} object that follows the boundary of a triangle from point $p_1$ to point $p_2$
...
% subsubsection method_tkzmeth_triangle_path (end)
