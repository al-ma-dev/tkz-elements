...
\section{Class \tkzClass{point}} % (fold)
...
\subsection{Creating a Point} % (fold)
...
% subsection creating_a_point (end)
...
\subsubsection{Attribute \tkzAttr{point}{mtx}} % (fold)
...
\catcode`_=12
\small
\captionof{table}{Functions and Methods of the \code{class} point.}\label{point:met}
\begin{tabular}{lll}
\toprule
...
\subsubsection{Method \tkzMeth{point}{new(r, r)}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{get()}} % (fold)
...
\end{tkzexample}
\end{minipage}
% subsubsection method_point_get (end)

\subsubsection{Method \tkzMeth{point}{polar(r, an)}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{polar\_deg(d,an)}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{north(d)}} % (fold)
...
\end{center}
\end{tkzexample}
% subsubsection example_method_point_north_d (end)


\subsubsection{Method \tkzMeth{point}{normalize()}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{orthogonal(d)}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{at(pt)}} % (fold)
...
% subsubsection _point_at_method (end)

\subsubsection{Method \tkzMeth{point}{rotation(obj)}} — First example % (fold)
...
\subsubsection{Method \tkzMeth{point}{rotation(an, obj)}} — Second example % (fold)
...
\subsubsection{Method \tkzMeth{point}{symmetry(obj)}} % (fold)
...
\subsubsection{Method \tkzMeth{point}{homothety(k, obj)}} % (fold)
...
% subsubsection _point_print (end)
